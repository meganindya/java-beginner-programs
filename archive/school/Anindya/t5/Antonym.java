...
class Antonym
{
    ...
    {
        PrintWriter pw=new PrintWriter(new BufferedWriter(new FileWriter("C:/Users/Anindya/Desktop/Antonym/sm.txt")));
        ...
        for(int i=0;i<n;i++)
        {
            System.out.print("Choose correct antonym for the word -"+"\n");
            if(a[i][0].length()<8)
                pw.print(a[i][0]+"\t\t");
            else
                pw.print(a[i][0]+"\t");
    ...
    {
        BufferedReader br1=new BufferedReader(new FileReader("C:/Users/Anindya/Desktop/Antonym/ant.txt"));
        BufferedReader br2=new BufferedReader(new FileReader("C:/Users/Anindya/Desktop/Antonym/ans.txt"));
    ...
    {
        BufferedReader br=new BufferedReader(new FileReader("C:/Users/Anindya/Desktop/Antonym/sm.txt"));
 ...
 * Word		Antonym		Response
 * --- 		----   		-----   
 * prosaic	romantic	Wrong
 * enervate	invigorate	Correct
 * torpor	activity	Wrong
 * nexus	schism		Wrong
 */