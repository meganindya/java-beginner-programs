...
class Meaning
{
    ...
    {
        BufferedReader br1=new BufferedReader(new FileReader("C:/Users/Anindya/Desktop/Meaning/words.txt"));
    ...
    {
        PrintWriter pw1=new PrintWriter(new BufferedWriter(new FileWriter("C:/Users/Anindya/Desktop/Meaning/meaning.txt")));
        PrintWriter pw2=new PrintWriter(new BufferedWriter(new FileWriter("C:/Users/Anindya/Desktop/Meaning/ans.txt")));
        for(int i=0;i<n;i++)
        {
            pw1.print(a[i][0]);
            for(int j=1;j<5;j++)
